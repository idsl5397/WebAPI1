...
namespace WebAPI1.Migrations
{
    ...
    [Migration("20250417025354_add _productionSite")]
    partial class add_productionSite
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI1.Entities.KpiItem", b =>
                {
                    ...
                    b.HasIndex("IndicatorNumber", "KpiCategoryId", "OrganizationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("WebAPI1.Entities.KpiData", b =>
                {
                    b.HasOne("WebAPI1.Entities.CompanyName", null)
                        .WithMany("KpiDatas")
